...
final class PinLayoutTest {
    ...
    void createWithNullRedThrowsIllegalArgumentException() {
        assertThrows(IllegalArgumentException.class, () -> PinLayout.create(null, RaspiPin.GPIO_02, RaspiPin.GPIO_03));
    }

    @Test
    void createWithNullGreenThrowsIllegalArgumentException() {
        assertThrows(IllegalArgumentException.class, () -> PinLayout.create(RaspiPin.GPIO_00, null, RaspiPin.GPIO_03));
    }

    @Test
    void createWithNullBlueThrowsIllegalArgumentException() {
        assertThrows(IllegalArgumentException.class, () -> PinLayout.create(RaspiPin.GPIO_00, RaspiPin.GPIO_02, null));
    }
